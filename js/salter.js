...
(function() {
  var _, args, asciiJoin, asciiLines, choki, colors, config, ext, font, fs, hash, hashfill, log, noon, opt, path, resolve, salt, sds, slash, slashfill, watch, write,
